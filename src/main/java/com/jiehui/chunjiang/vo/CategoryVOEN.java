...
public class CategoryVOEN {
    ...
    private List<GoodsCategoryEnEntity> categoryVOS;
    ...
    public List<GoodsCategoryEnEntity> getCategoryVOS() {
        return categoryVOS;
    }

    public void setCategoryVOS(List<GoodsCategoryEnEntity> categoryVOS) {
